	...
	<div class="grid grid-cols-12 gap-6">
		<div class="col-span-12 xxl:col-span-9 grid grid-cols-12 gap-6">
					...
					<div class="col-span-6 intro-y">
						<div class="report-box zoom-in">
							<div class="box p-5">
								...
								<div class="text-3xl font-bold leading-8 mt-6">{{ $cp }}</div>
								<div class="text-base text-gray-600 mt-1">All Content Post</div>
							</div>
						</div>
					</div>
					@endif
					...
					<div class="col-span-3 intro-y">
						<div class="report-box zoom-in">
							<div class="box p-5">
								...
								<div class="text-3xl font-bold leading-8 mt-6">{{ $cc }}</div>
								<div class="text-base text-gray-600 mt-1">My Content Post</div>
							</div>
						</div>
					</div>
					<div class="col-span-3 intro-y">
						<div class="report-box zoom-in">
							<div class="box p-5">
								...
								<div class="text-3xl font-bold leading-8 mt-6">{{ $cr }}%</div>
								<div class="text-base text-gray-600 mt-1">My Contribution</div>
							</div>
						</div>
					</div>
					...
					<div class="col-span-4 intro-y">
						<div class="report-box zoom-in">
							<div class="box p-5">
								...
								<div class="text-3xl font-bold leading-8 mt-6">{{ $adm }}</div>
								<div class="text-base text-gray-600 mt-1">Admin</div>
							</div>
						</div>
					</div>
					<div class="col-span-4 intro-y">
						<div class="report-box zoom-in">
							<div class="box p-5">
								...
								<div class="text-3xl font-bold leading-8 mt-6">{{ $atr }}</div>
								<div class="text-base text-gray-600 mt-1">Author</div>
							</div>
						</div>
					</div>
					<div class="col-span-4 intro-y">
						<div class="report-box zoom-in">
							<div class="box p-5">
								...
								<div class="text-3xl font-bold leading-8 mt-6">{{ $gst }}</div>
								<div class="text-base text-gray-600 mt-1">Guest</div>
							</div>
						</div>
					</div>
					@endif
			...
			<div class="col-span-12">
				<canvas id="line-chart-widget" widht="100%"></canvas>
			</div>
    ...
    <!-- <div class="row">
        ...
        <div class="col-lg-4 col-xs-6">
          <div class="small-box bg-aqua">
            <div class="inner">
              ...
              <p>All Content Post</p>
            </div>
            <div class="icon">
              <i class="ion ion-bag"></i>
            </div>
            <a href="{{ route('viverb-esport-be-content-all') }}" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        @endif

        <div class="{{ Auth::user()->role_id == 3 ? 'col-lg-6' : 'col-lg-4' }} col-xs-6">
          <div class="small-box bg-aqua">
            <div class="inner">
              <h3>{{ $cc }}</h3>
            ...
            <a href="{{ route('viverb-esport-be-content-my') }}" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <div class="{{ Auth::user()->role_id == 3 ? 'col-lg-6' : 'col-lg-4' }} col-xs-6">
          <div class="small-box bg-green">
            <div class="inner">
              <h3>{{ $cr }}<sup style="font-size: 20px">%</sup></h3>
        ...
        <div class="col-lg-4 col-xs-6">
          <div class="small-box bg-yellow">
            ...
            <a href="{{ route('viverb-esport-be-user-admin') }}" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <div class="col-lg-4 col-xs-6">
          <div class="small-box bg-yellow">
            ...
            <a href="{{ route('viverb-esport-be-user-author') }}" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <div class="col-lg-4 col-xs-6">
          <div class="small-box bg-red">
            ...
            <a href="{{ route('viverb-esport-be-user-guest') }}" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        @endif
    </div> -->
        ...
        @if(Auth::user()->role_id == 1 || Auth::user()->role_id == 2)
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Graph All Contribution {{ date('Y') }}</h3>
            ...
            <div class="box-body">
              <div class="chart">
                <canvas id="areaChartAll" style="height:250px"></canvas>
              </div>
            </div>
          </div>
        @endif
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Graph My Contribution {{ date('Y') }}</h3>
            ...
            <div class="box-body">
              <div class="chart">
                <canvas id="areaChartMy" style="height:250px"></canvas>
              </div>
            </div>
          </div>
        </section>
