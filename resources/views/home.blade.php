...
<body>
  ...
  <div class="mobile-menu-wrap">
    ...
    <ul class="mobile-menu">
      ...
      <li class="mobile-menu-item">
        <a href="index-2.html" class="mobile-menu-item-link">Home</a>
      </li>
      <!-- /MOBILE MENU ITEM -->
        ...
        <ul class="mobile-dropdown pd-dropdown">
          ...
          <li class="mobile-dropdown-item">
            ...
            <ul class="mobile-dropdown pd-dropdown">
              <!-- MOBILE DROPDOWN ITEM -->
              <li class="mobile-dropdown-item">
                <a href="index-2.html" class="mobile-dropdown-item-link">Main Homepage</a>
              </li>
              <!-- /MOBILE DROPDOWN ITEM -->
    ...
    <div class="navigation grid-limit">
      ...
      <ul class="main-menu">
        ...
        <li class="main-menu-item">
          <a href="index-2.html" class="main-menu-item-link">Home</a>
        </li>
        <!-- /MAIN MENU ITEM -->
              ...
              <div class="link-sections">
                ...
                <div class="link-section">
                  ...
                  <ul class="link-list">
                    <!-- LINK LIST ITEM -->
                    <li class="link-list-item">
                      <a href="index-2.html">Main Homepage</a>
                    </li>
                    <!-- /LINK LIST ITEM -->
  ...
  <div class="banner-wrap forum-banner">
    ...
    <div class="banner grid-limit">
      <h2 class="banner-title">Headers &amp; Dividers</h2>
      <p class="banner-sections">
        ...
        <!-- /ARROW ICON -->
        <span class="banner-section">Headers &amp; Dividers</span>
      </p>
    </div>
    <!-- /BANNER -->
  </div>
  ...
  <div class="banner-display-separator"></div>
  <!-- /BANNER DISPLAY SEPARATOR -->
      ...
      <div class="slider-item slider-item-1">
        <div class="slider-item-wrap">
          ...
          <div class="post-preview huge gaming-news">
            ...
            <!-- POST PREVIEW TEXT -->
            <p class="post-preview-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
            <!-- BUTTON -->
  ...
  <!-- BANNER SLIDER -->
  <div id="banner-slider-3" class="banner-slider v3">
    <!-- SLIDER ITEMS -->
    <div class="slider-items">
      <!-- POST PREVIEW -->
        ...
        <a href="post-v2.html">
          <div class="post-preview-img-wrap">
            ...
            <div class="post-preview-overlay">
              ...
              <p class="post-preview-title">We reviewed the new Magimons game</p>
              <!-- POST PREVIEW TEXT -->
              <p class="post-preview-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt dutor et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud citation loso laboris tempora aliquip.</p>
            </div>
            <!-- /POST PREVIEW OVERLAY -->
          </div>
        </a>
        ...
        <a href="esports-post.html">
          <div class="post-preview-img-wrap">
            ...
            <div class="post-preview-overlay">
              ...
              <p class="post-preview-title">Gwen Parker is leading her team to the semifinals</p>
              <!-- POST PREVIEW TEXT -->
              <p class="post-preview-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore.</p>
            </div>
            <!-- /POST PREVIEW OVERLAY -->
          </div>
        </a>
        ...
        <div class="post-preview picture medium e-sport">
          ...
          <a href="esports-post.html">
            <div class="post-preview-img-wrap">
              <!-- POST PREVIEW IMG -->
              <figure class="post-preview-img liquid">
                <img src="img/posts/55.jpg" alt="post-55">
              </figure>
              <!-- /POST PREVIEW IMG -->
              ...
              <div class="post-preview-overlay">
                ...
                <!-- POST PREVIEW TITLE -->
                <p class="post-preview-title">Xenowatch finals will be held in Hawaii this October 4th</p>
              </div>
              <!-- /POST PREVIEW OVERLAY -->
            </div>
          </a>
        ...
        <div class="post-preview picture medium e-sport">
          ...
          <a href="esports-post.html">
            <div class="post-preview-img-wrap">
              <!-- POST PREVIEW IMG -->
              <figure class="post-preview-img liquid">
                <img src="img/posts/57.jpg" alt="post-57">
              </figure>
              <!-- /POST PREVIEW IMG -->
              ...
              <div class="post-preview-overlay">
                ...
                <!-- POST PREVIEW TITLE -->
                <p class="post-preview-title">The Striker Go finals will be broadcasted live by ESP-TV</p>
              </div>
              <!-- /POST PREVIEW OVERLAY -->
            </div>
          </a>
  ...
  <div class="banner-wrap gaming-news">
    <!-- BANNER -->
    <div class="banner grid-limit">
      <h2 class="banner-title">Blue &amp; Cyan Banner</h2>
      <p class="banner-sections">
        <span class="banner-section">Home</span>
        <!-- ARROW ICON -->
        <svg class="arrow-icon">
        ...
        <!-- /ARROW ICON -->
        <span class="banner-section">Blue &amp; Cyan Banner</span>
      </p>
    </div>
    <!-- /BANNER -->
  </div>
  ...
  <div class="banner-wrap game-review">
    <!-- BANNER -->
    <div class="banner grid-limit">
      <h2 class="banner-title">Violet &amp; Red Banner</h2>
      <p class="banner-sections">
        <span class="banner-section">Home</span>
        <!-- ARROW ICON -->
        <svg class="arrow-icon">
        ...
        <!-- /ARROW ICON -->
        <span class="banner-section">Violet &amp; Red Banner</span>
      </p>
    </div>
    <!-- /BANNER -->
  </div>
  ...
  <div class="banner-wrap movie-reviews">
    <!-- BANNER -->
    <div class="banner grid-limit">
      <h2 class="banner-title">Dark Green &amp; Light Green Banner</h2>
      <p class="banner-sections">
        <span class="banner-section">Home</span>
        <!-- ARROW ICON -->
        <svg class="arrow-icon">
        ...
        <!-- /ARROW ICON -->
        <span class="banner-section">Dark Green &amp; Light Green Banner</span>
      </p>
    </div>
    <!-- /BANNER -->
  </div>
  ...
  <div class="banner-wrap geeky-news">
    <!-- BANNER -->
    <div class="banner grid-limit">
      <h2 class="banner-title">Orange &amp; Yellow Banner</h2>
      <p class="banner-sections">
        <span class="banner-section">Home</span>
        <!-- ARROW ICON -->
        <svg class="arrow-icon">
        ...
        <!-- /ARROW ICON -->
        <span class="banner-section">Orange &amp; Yellow Banner</span>
      </p>
    </div>
    <!-- /BANNER -->
  </div>
  ...
  <div class="banner-wrap e-sport">
    <!-- BANNER -->
    <div class="banner grid-limit">
      <h2 class="banner-title">Dark Violet &amp; Light Violet Banner</h2>
      <p class="banner-sections">
        <span class="banner-section">Home</span>
        <!-- ARROW ICON -->
        <svg class="arrow-icon">
        ...
        <!-- /ARROW ICON -->
        <span class="banner-section">Dark Violet &amp; Light Violet Banner</span>
      </p>
    </div>
    <!-- /BANNER -->
  </div>
  ...
  <div class="banner-wrap pixel-videos">
    <!-- BANNER -->
    <div class="banner grid-limit">
      <h2 class="banner-title">Dark Cyan &amp; Light Cyan Banner</h2>
      <p class="banner-sections">
        <span class="banner-section">Home</span>
        <!-- ARROW ICON -->
        <svg class="arrow-icon">
        ...
        <!-- /ARROW ICON -->
        <span class="banner-section">Dark Cyan &amp; Light Cyan Banner</span>
      </p>
    </div>
    <!-- /BANNER -->
  </div>
  ...
  <div class="banner-wrap forum-banner">
    <!-- BANNER -->
    <div class="banner grid-limit">
      <h2 class="banner-title">Red &amp; Blue Banner</h2>
      <p class="banner-sections">
        <span class="banner-section">Home</span>
        <!-- ARROW ICON -->
        <svg class="arrow-icon">
        ...
        <!-- /ARROW ICON -->
        <span class="banner-section">Red &amp; Blue Banner</span>
      </p>
    </div>
    <!-- /BANNER -->
  </div>
  ...
  <div class="banner-wrap shop-banner">
    <!-- BANNER -->
    <div class="banner grid-limit">
      <h2 class="banner-title">Violet &amp; Cyan Banner</h2>
      <p class="banner-sections">
        <span class="banner-section">Home</span>
        <!-- ARROW ICON -->
        <svg class="arrow-icon">
        ...
        <!-- /ARROW ICON -->
        <span class="banner-section">Violet &amp; Cyan Banner</span>
      </p>
    </div>
    <!-- /BANNER -->
  </div>
