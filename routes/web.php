...
Route::post('/post-content', 'App\Http\Controllers\PostArtikelController@tambah')->name('tambahdata');
...
Route::get('/post-artikel', 'App\Http\Controllers\PostArtikelController@post')->name('post-artikel');